    ...
    <v-navigation-drawer v-model="drawer" absolute temporary>
      ...
      <v-list>
        ...
        >
          ...
          <v-list-item v-for="child in item.items" :key="child.id" @click=goTo(item.id,child.id)>
            <v-list-item-content>
  ...
  export default {
        ...
        items: [
          {
            ...
            items: [
              { id: 1, title: "所有客戶", link: "client_list",type: "all"},
              { id: 2, title: "新雙贏客戶", link: "client_list", type: "newwinwin"},
              { id: 3, title: "舊雙贏客戶", link: "client_list", type: "free"},
              { id: 4, title: "舊年費客戶", link: "client_list", type: "normal" },
              { id: 5, title: "經銷商", link: "client_list", type: "dealer" },
              { id: 6, title: "有設定GA的客戶",link: "client_list", type: "google" },
              { id: 7, title: "有開啟Enhanced的客戶", link: "client_list", type: "ec" },
            ],
            title: "客戶列表",
          },
          {
    ...
    methods: {
      ...
      goTo(id1, id2) {
        ...
        const route = childItem[0].link.split("_")
        console.log(route)
